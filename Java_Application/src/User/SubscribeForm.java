...
public class SubscribeForm extends javax.swing.JFrame {
    ...
    public SubscribeForm () throws  Exception{
     ...
     public ResultSet getResultFromSub() {
       ...
       try{
          rs=stmt.executeQuery("Select E.Name_Ed, Date_Sub, Period_Sub, Cena from Subscribe S, Recipient R,Editions E  where S.id_recipient=R.id_recipient and S.Index_Ed=E.Index_Ed");
    ...
    private void initComponents() {
        ...
        jPanel1.setLayout(new java.awt.GridLayout(1, 2, 1, 2));
        ...
        jTable1.setModel(new User.Subscribe(rs));
        mdbc.close(rs);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(SubscribeForm.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        Admin.Subscribe table = (Admin.Subscribe )jTable1.getModel();
//        TableRowSorter <Admin.Subscribe > tr = new TableRowSorter <Admin.Subscribe >(table);
